...
public final class BottomDialogMenu extends BottomSheetDialogFragment {
    ...
    /**
     * @param direction LAYOUT_DIRECTION_RTL, LAYOUT_DIRECTION_LTR.<br/> Default value is LAYOUT_DIRECTION_RTL
     */
    ...
    /**
     * @param titleGravity The Gravity of Dialog's Title .<br/>
    ...
    private void addItems(LayoutInflater inflater, View root) {
        ...
        for (Item i : this.items) {
            View v = inflater.inflate(this.direction == LAYOUT_DIRECTION_RTL ? R.layout.row_rtl : R.layout.row_ltr
                    , llContainer, false);
